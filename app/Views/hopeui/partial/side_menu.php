    ...
    <div class="sidebar-body pt-0 data-scrollbar">
      <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if($uri->getSegment(1) == "kategori_buku"){echo "active";}?>" href="<?=base_url('kategori_buku')?>"><i class="fa-regular fa-list"></i><span class="item-name">Kategori Buku</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link <?php if($uri->getSegment(1) == "peminjaman"){echo "active";}?>"><i class="fa-duotone fa-arrow-right-arrow-left"></i><span class="item-name">Data Peminjaman</span>
            </a>
          </li>
